...
#ifndef _SAM_BA_UART_H_
#define _SAM_BA_UART_H_
 ...
 */
uint32_t uart_putdata(void const* data, uint32_t length); //Send given data (polling)
 ...
 * \return value read on usart line
 */
uint32_t uart_getdata(void* data, uint32_t length); //Get data from comm. device
 ...
 * \return number of data sent
 */
uint32_t uart_putdata_xmd(void const* data, uint32_t length); //Send given data (polling) using xmodem (if necessary)
 ...
 * \return value read on usart line
 */
uint32_t uart_getdata_xmd(void* data, uint32_t length); //Get data from comm. device using xmodem (if necessary)
